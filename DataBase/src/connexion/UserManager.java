...
/**
 * This class allows to manage users by loading their information from a file
 * and saving it to the same file
 *
 */
public class UserManager {
	...
	/**
	 * This method load the users contained in the file 'user' and add them to
	 * the user list
	 */
	...
	/**
	 * This method add a new user to the user list. Do nothing if a user with
	 * the same login and same password exists
	 * 
	 * @param login
	 *            new user's login
	 * @param pass
	...
	/**
	 * This method check if a user with login and password exists in the user
	 * list
	 * 
	 * @param login
	 *            login to test
