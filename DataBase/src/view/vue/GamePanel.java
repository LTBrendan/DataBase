...
public class GamePanel extends JPanel {
	...
	public GamePanel(String question, String answer1, String answer2, String answer3, String answer4) {
		...
		questionPanel.setPreferredSize(new Dimension(WorkPanel.width, WorkPanel.height / 15));
		questionPanel.setBackground(new Color(AppFrame.color, AppFrame.color + 3, AppFrame.color + 8));
		questionPanel.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, Color.WHITE));
		questionPanel.setLayout(new FlowLayout());

		questionLabel = new JLabel("Question : " + question);
		questionLabel.setHorizontalAlignment(SwingConstants.RIGHT);
		questionLabel.setVerticalAlignment(questionPanel.getHeight() / 2);
