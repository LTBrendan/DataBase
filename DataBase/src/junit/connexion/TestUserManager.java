...
public class TestUserManager {
	...
	public void testCreateUser () {
		...
		assertFalse (testUM.getUserList().contains(user2));
		assertTrue (testUM.getUserList().size() == 1);
		UserManager.createUser(new String ("user1"), new String ("password1"));
		assertFalse (testUM.getUserList().size() == 2);
	}
	...
	public void testCheckUser () {
		...
		//assertTrue (UserManager.checkUser(new String("user1"), new String ("password1")));
	}
	...
	public void testRemoveUser () {
		...
		assertTrue (testUM.getUserList().size() == 2);
